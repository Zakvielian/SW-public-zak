...
public sealed class BadSmellItemTrackerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BadSmellItemTrackerComponent, GetItemActionsEvent>(OnGetActions);
    ...
    private void OnGetActions(Entity<BadSmellItemTrackerComponent> ent, ref GetItemActionsEvent args)
    {
        if (args.InHands)
            return;

        args.AddAction(ref ent.Comp.ActionEntity, ent.Comp.ActionProto);
    }
    ...
    private void OnTrackAction(Entity<BadSmellItemTrackerComponent> ent, ref BadSmellItemTrackerActionEvent args)
    {
        ...
        if (smellItem.Toucher is not { } targetEnt || !Exists(targetEnt))
        {
