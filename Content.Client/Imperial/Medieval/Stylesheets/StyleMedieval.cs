...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleMedieval : StyleBase
    {
        ...
        public static readonly Color PanelDark = Color.FromHex("#0dff00");
        ...
        public static readonly Color ButtonColorDefault = Color.FromHex("#00ffd9");
        ...
        // Imperial Pass Begin
        public static readonly Color ButtonColorDefaultPass = Color.FromHex("#6fff00");
        ...
        public static readonly Color ChatBackgroundColor = Color.FromHex("#ff0000dd");
        ...
        public StyleMedieval(IResourceCache resCache) : base(resCache)
        {
